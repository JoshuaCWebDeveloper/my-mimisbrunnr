...
describe('Security Facade Tests', () => {
    ...
    describe('Rate Limiting Tests', () => {
        it('should apply rate limits to API endpoints', async () => {
            ...
            const requests = Array(100)
                .fill(null)
                .map(() => makeRequest('GET', '/api/v0/version'));
        ...
        it('should have different rate limits for different endpoints', async () => {
            ...
            const pinRequests = Array(50)
                .fill(null)
                .map(() => makeRequest('POST', '/api/v0/pin/add?arg=QmTest'));
    ...
    describe('Pubsub Facade Security', () => {
        ...
        it('should enforce message size limits', async () => {
            ...
            const response = await makeRequest(
                'POST',
                '/api/v0/pubsub/pub?arg=mimis/taglist/test',
                {
                    data: largeMessage,
                }
            );
